...
def test_cartesia_supports_sonic_3_5(fake_settings: Settings) -> None:
    """sonic-3.5 (the public matrix entry) constructs and reports its name."""
...
def test_cartesia_supports_sonic_3_6(fake_settings: Settings) -> None:
    """sonic-3.6 (the public matrix entry) constructs and reports its name."""
    p = CartesiaTTSProvider(
...
def test_cartesia_supports_sonic_preview(fake_settings: Settings) -> None:
    """sonic-preview (the early-access entry) constructs and reports its name."""
    p = CartesiaTTSProvider(
