...
MODEL_REGISTRY: list[RegisteredModel] = [
    ...
    # Fish Audio. Voices are library reference_ids: Marlowe (female), Sawyer (male).
    RegisteredModel(
        benchmark=_TTS,
        provider="fishaudio",
        model="s1",
        voice="4501d82f5de3467ebf4d7ef095a2deee",
        voices=("4501d82f5de3467ebf4d7ef095a2deee", "fa4c9eb3dccc4806b382b40d61c6b10a"),
        tags=(_STREAMING, _MULTI, _CLONE, _EMOTION, _STREAM),
        region="us-west-1",
        status=_ACTIVE,
    ),
