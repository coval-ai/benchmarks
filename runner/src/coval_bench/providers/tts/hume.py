...
class HumeTTSProvider(TTSProvider):
    ...
    async def synthesize(self, text: str) -> TTSResult:
        ...
        synthesis = Synthesis("hume", self._model, voice_id, SAMPLE_RATE)
        ...
        try:
            ...
            synthesis.error = f"Hume WebSocket session timed out after {_WS_SESSION_TIMEOUT_S}s"
            synthesis.chunks.clear()
