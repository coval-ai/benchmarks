...
the reference transcript and the provider hypothesis. 

**Version constant.** `wer.NORM_VERSION` is bumped on any
...
To reduce benchmark gaming, detailed normalization rules are maintained in
internal evaluation docs and are not listed here.
